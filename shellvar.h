...
/**
 * struct sev_s - Func for shell env
 * vars
 * @skywalker: flag to continue or not
 * continue with shell
 ...
 * log counter
 * @mem: ptr to mem alloc for the
 * current shell session
 * @env: ptr to the os env vars
 * @evp: ptr to env vars in arr
 * @input: ptr to the user's input
 * @p_input: ptr to the procssed input
 * @error: error num from current
 * command
 * @errmsg: error mess associated with
 * the error num
 * @olderror: error from previous cmd
 * @pid: pid of current shell
 * @alias: ptr to link list of all alias
 * created by user
 * @cmd_q: ptr to the list of cmds in d queue
