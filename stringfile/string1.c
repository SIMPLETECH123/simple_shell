#include "string.h"
/**
 * _strdup - func that returns a p to a newl alloc space
...
/**
 * _strspn - get the length of a prefix substr
 * @s: str s to process
...
/**
 * _strpbrk - search a str for any of a set of bytes
...
/**
 * _strlen - function get the length of the input str
 * @s: input char * string
...
/**
 * _strtok - take in a str and splits it into tokens based on delim
 * @s: input char * string
