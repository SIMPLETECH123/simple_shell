#include "linklist.h"
/**
 * add_node - to add a new node at the start of a linked list
...
/**
 * reverse_list - to reverse a linked list
...
/**
 * free_list - to free a linked list and sets the head to NULL
 * @head: list_t type
...
/**
 * delete_node_at_index - to delete node at index
